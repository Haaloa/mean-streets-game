...
def make_test_game():
    ...
    ctrl = game.createInteractionController()
...
class TestSelectObject(unittest.TestCase):
    ...
    def test_select_existing_object(self):
        result = self.ctrl.pickGameObject("test_object")
        self.assertIsNotNone(result)
        self.assertEqual(result.name, "test_object")

    def test_can_see_interactions_after_select(self):
        self.ctrl.pickGameObject("test_object")
        types = self.ctrl.getInteractionTypes()
        self.assertGreater(len(types), 0)

    def test_new_selection_clears_old(self):
        self.ctrl.pickGameObject("test_object")
        self.ctrl.chooseInteraction("LookAtStrategy")
        self.ctrl.pickGameObject("test_object")
        self.assertIsNone(self.ctrl.selectedStrategy)

    def test_select_nonexistent_object(self):
        result = self.ctrl.pickGameObject("ghost_lamp")
        self.assertIsNone(result)

    def test_select_with_no_scene(self):
        empty_game = Game()
        ctrl = InteractionController(empty_game)
        result = ctrl.pickGameObject("test_object")
        self.assertIsNone(result)
...
class TestChooseInteraction(unittest.TestCase):
    ...
    def test_choose_by_name(self):
        result = self.ctrl.chooseInteraction("LookAtStrategy")
        self.assertTrue(result)

    def test_correct_type_chosen(self):
        self.ctrl.chooseInteraction("TurnItOnStrategy")
        self.assertIsInstance(self.ctrl.selectedStrategy, TurnItOnStrategy)
    ...
    def test_all_8_interactions_work(self):
        ...
        for name in interactions:
            self.ctrl.pickGameObject("test_object")
            result = self.ctrl.chooseInteraction(name)
            self.assertTrue(result)
    ...
    def test_choose_nonexistent(self):
        result = self.ctrl.chooseInteraction("FlyAwayStrategy")
        self.assertFalse(result)

    def test_choose_without_object(self):
        _, _, new_ctrl = make_test_game()
        result = new_ctrl.chooseInteraction("LookAtStrategy")
        self.assertFalse(result)
...
class TestProvideOptions(unittest.TestCase):
    ...
    def test_options_for_move(self):
        self.ctrl.chooseInteraction("MoveItStrategy")
        result = self.ctrl.provideOptions("to the left")
        self.assertTrue(result)

    def test_options_in_result(self):
        self.ctrl.chooseInteraction("MoveItStrategy")
        self.ctrl.provideOptions("to the left")
        result = self.ctrl.performInteraction()
        self.assertIn("to the left", result)

    def test_options_when_not_needed(self):
        self.ctrl.chooseInteraction("LookAtStrategy")
        result = self.ctrl.provideOptions("irrelevant")
        self.assertFalse(result)

    def test_options_without_interaction(self):
        result = self.ctrl.provideOptions("north")
        self.assertFalse(result)
...
class TestPerformInteraction(unittest.TestCase):
    ...
    def _setup(self, name):
        self.ctrl.pickGameObject("test_object")
        self.ctrl.chooseInteraction(name)
    ...
    def test_turn_on_changes_state(self):
        ...
        self.ctrl.performInteraction()
        self.assertTrue(self.ctrl.selectedObject.is_on)
    ...
    def test_turn_off_changes_state(self):
        ...
        self.ctrl.performInteraction()
        self.assertFalse(self.ctrl.selectedObject.is_on)
...
class TestGame(unittest.TestCase):
    ...
    def test_which_scene(self):
        ...
        scene = TestScene()
        game.set_scene(scene)
        self.assertIs(game.whichSceneAmIIn(), scene)
