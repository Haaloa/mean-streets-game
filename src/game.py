...
class Game:
    ...
    def _setup_world(self):
        ...
        statue = GameObject(
            "statue",
            "A bronze statue of Karl XI on horseback. Looks very old."
        )
        ...
        phone = GameObject(
            "phone",
            "A smartphone lying on the ground. The screen is cracked."
        )
        ...
        bench = GameObject(
            "bench",
            "A wooden park bench. Someone left a newspaper on it."
        )
        ...
        anna.add_response(
            "murder",
            "I saw someone running from the alley last night. I was too scared to look closely."
        )
        anna.add_response(
            "phone",
            "That phone? I think it belonged to the victim. I saw him drop it."
        )
        anna.add_response(
            "statue",
            "People meet here all the time. I saw two men arguing near it yesterday."
        )
        anna.add_response(
            "hello",
            "Oh! You scared me. Are you with the police?"
        )
        anna.add_response(
            "who",
            "My name is Anna. I live just around the corner."
        )
        anna.add_response(
            "clue",
            "Check the alley behind the bakery. I think they went that way."
        )

        clue_note = GameObject(
            "clue note",
            "A crumpled note: 'Meet me at the docks. Midnight. -V'"
        )
        ...
        notebook = GameObject(
            "notebook",
            "Your detective's notebook. Several pages already filled."
        )
